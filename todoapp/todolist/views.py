...
def my_todos(request): 
    ...
    Task_ID_Business = TodoList.objects.filter(category__name="Business") 
    Task_ID_Personal = TodoList.objects.filter(category__name="Personal")
    Task_ID_Other = TodoList.objects.filter(category__name="Other")
